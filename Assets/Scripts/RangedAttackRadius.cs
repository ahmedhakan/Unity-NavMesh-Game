...
public class RangedAttackRadius : AttackRadius
{
    ...
    protected override IEnumerator Attack()
    {
        ...
        while (Damageables.Count > 0) // if there is target in radius
        {
            ...
            {
                PoolableObject poolableObject = BulletPool.GetObject(); // spawn bullet
            ...
            {
                Agent.enabled = true; // no target in radius, get closer
            }
    ...
    private bool HasLineOfSightTo(Transform Target) // check the line to target 
    {
